    ...
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200">
        <div className="px-4 sm:px-6 py-4 border-b border-gray-200">
          <h3 className="text-base sm:text-lg font-semibold text-gray-900">Rush Hours Management</h3>
          <p className="text-xs sm:text-sm text-gray-600 mt-1">Define time periods when special rates apply</p>
        </div>
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 sm:p-4">
            <div className="flex items-start space-x-2 sm:space-x-3">
              ...
              <div className="flex-1">
                <p className="text-xs sm:text-sm font-medium text-yellow-800">Rush Hours Effect</p>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200">
        <div className="px-4 sm:px-6 py-4 border-b border-gray-200">
          <h3 className="text-base sm:text-lg font-semibold text-gray-900">Current Rush Hours</h3>
        </div>
        <div className="divide-y divide-gray-200">
          {rushHours.map((rushHour) => (
            <div key={rushHour.id} className="p-4 sm:p-6 flex flex-col sm:flex-row sm:items-center sm:justify-between hover:bg-gray-50 space-y-3 sm:space-y-0">
              <div className="flex items-start space-x-3">
                <div className={`w-2 h-2 sm:w-3 sm:h-3 rounded-full ${rushHour.active ? 'bg-green-500 animate-pulse' : 'bg-gray-400'} mt-1 flex-shrink-0`}></div>
          ...
          {rushHours.length === 0 && (
            <div className="p-6 text-center text-gray-500">
              <Clock className="w-8 h-8 sm:w-10 sm:h-10 mx-auto mb-2 text-gray-400" />
              <p className="text-sm sm:text-base">No rush hours configured</p>
              <p className="text-xs sm:text-sm mt-1">Add your first rush hour period above</p>
            </div>
          )}
        </div>
      </div>
